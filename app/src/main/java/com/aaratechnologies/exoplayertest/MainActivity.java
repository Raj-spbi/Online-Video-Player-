package com.aaratechnologies.exoplayertest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initPlayer() {
        ...
        playYouTubeVideo("https://www.youtube.com/watch?v=l-PTrjFaDJk");
    }
    ...
    private void playYouTubeVideo(String s) {
        ...
        new YouTubeExtractor(this) {
            ...
            protected void onExtractionComplete(@Nullable SparseArray<YtFile> ytFiles, @Nullable VideoMeta videoMeta) {
                if (ytFiles!=null){
                    int videoTag=137;  //Video tag for 1080p MP4(You can debug ytFiles to get Tag)
                    int audioTag=140;  //For MP4A
                    ...
                    MediaSource vediosource=new ProgressiveMediaSource.Factory(new DefaultHttpDataSource.Factory())
